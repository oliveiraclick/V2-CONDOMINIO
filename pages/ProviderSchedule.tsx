...
export const ProviderSchedule: React.FC = () => {
  ...
  const PERIOD_CONFIG = [
    { id: 'm1', label: 'Manhã I', time: '07:00 - 09:00', icon: <Sunrise size={20} /> },
    { id: 'm2', label: 'Manhã II', time: '09:01 - 12:00', icon: <Sun size={20} /> },
    { id: 't1', label: 'Tarde I', time: '13:00 - 15:00', icon: <Sun size={20} /> },
    { id: 't2', label: 'Tarde II', time: '15:01 - 18:00', icon: <Moon size={20} /> },
  ];

  // Mock Appointments
  const [slots, setSlots] = useState<Slot[]>([
    { 
      id: 'm1', period: 'm1', label: 'Manhã I', time: '07:00 - 09:00', icon: <Sunrise size={20} />, 
      status: 'pending', 
      source: 'platform',
    ...
    { 
      id: 'm2', period: 'm2', label: 'Manhã II', time: '09:01 - 12:00', icon: <Sun size={20} />, 
      status: 'booked',
      source: 'platform',
      client: { name: 'Ana Souza', avatar: 'https://i.pravatar.cc/100?u=ana', service: 'Limpeza Pesada', address: 'Bl. C - 302', phone: '5511988888888' }
    },
    { 
      id: 't1', period: 't1', label: 'Tarde I', time: '13:00 - 15:00', icon: <Sun size={20} />, 
      status: 'free',
    },
    { 
      id: 't2', period: 't2', label: 'Tarde II', time: '15:01 - 18:00', icon: <Moon size={20} />, 
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-900/60 backdrop-blur-sm animate-fade-in p-4">
           <div className="bg-white w-full max-w-md rounded-[32px] p-6 shadow-2xl animate-slide-up">
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => setManualSlotId(null)} className="p-2 bg-slate-50 rounded-full text-slate-400 hover:bg-slate-100"><X size={20} /></button>
              </div>
              ...
              <div className="space-y-3">
                 {selectedSlot.status === 'pending' && (
                    <Button fullWidth onClick={handleConfirm} className="!bg-green-500 hover:!bg-green-600 shadow-lg shadow-green-500/30">
                       <Check size={20} /> Confirmar Atendimento
                    </Button>
                 )}
                 ...
                 <Button fullWidth variant="ghost" onClick={handleReschedule}>
                    <CalendarDays size={20} /> Ajustar Data e Horário
                 </Button>
              </div>
           </div>
        </div>
